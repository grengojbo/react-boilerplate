...
// const store: any = configureStore(initialState, browserHistory);
...
ReactDOM.render(React.createElement(Hello, { name: 'bar' }), document.getElementById('app'));

// const render: any = (messages: string) => {
